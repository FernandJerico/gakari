        ...
        <div class="about-me d-block mt-5">
            <form action="{{ route('update.profile') }}" method="POST" class="d-flex flex-row w-100 px-5">
                ...
                <div class="col-lg-6 px-2">
                    ...
                    <div class="mb-4">
                        <textarea rows="16" type="text" placeholder="Biografi atau deskripsi diri" name="description" id="bio">{{ $profile->description }}</textarea>
                    </div>
                    <div class="mt-1">
                        <textarea type="text" placeholder="Keahlian" name="skill" id="keahlian">{{ $profile->skill }}</textarea>
                    </div>
                </div>
