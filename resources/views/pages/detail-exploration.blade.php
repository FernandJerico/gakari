    ...
    <div class="row d-flex flex-row">
        <div class="content-left col-lg-6">
            <div class="author-info w-100 d-flex justify-content-between">
                <div class="name">
                    @if ($data->user->image)
                    <img width="40px" style="border-radius: 50%" src="{{ asset('storage/user/' . $data->user->image) }}"
                        alt="author">
                    @else
                    <img width="40px" style="border-radius: 50%" src="{{ asset('images/default-profile.png') }}" @endif
        ...
        <div class="content-right col-lg-6">
            ...
            <div class="list-comment">
                <div class="d-flex flex-row align-items-center gap-1">
                    ...
                    @else
                    <img width="5%" style="border-radius: 50%" src="{{ asset('images/default-profile.png') }}">
                    @endif
